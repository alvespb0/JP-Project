...
<head>
    ...
    <title>Navbar com Efeito de Hover</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="formsEmpresa.php">Cadastro de Empresa</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="procuraEmpresa.php">Listar Empresas</a>
                </li>
                <li class="nav-item">
