...
<body>
    <div class="container mt-5">
        ...
        <form action="createEmpresa.php" method="post">
            ...
            <div class="mb-3">
                <label for="particularidades" class="form-label">observações sobre os links</label>
                <input type="text" id="OBS_links" name="OBS_links" class="form-control" placeholder="Observações">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="particularidades" class="form-label">observações sobre particularidades</label>
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="subformas_recebimento[]" value="Malote" id="subforma4">
            <label class="form-check-label" for="subforma4">Malote</label>
        </div>
        <div class="mb-3">
            <label for="obs recebimento" class="form-label">Observações sobre os recebimentos</label>
            <input type="text" id="OBS_recebimentos" name="OBS_recebimentos" class="form-control" placeholder="recebimentos">
        </div>
